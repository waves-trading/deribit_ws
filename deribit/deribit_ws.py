...
from .ws_middleware import WSExchange


class deribit(WSExchange):
    def describe(self):
    ...
    async def login_ws(self, *args, **kwargs):
        await self.fetch(
            url="auth",
            method="public",
            body={
    ...
    async def fetch_time(self, params={}):
        response = await self.fetch(url="get_time", method="public",body=params)
        #
        #     {
        #         jsonrpc: '2.0',
    ...
    async def fetch_markets(self, params={}):
        currenciesResponse = await self.fetch(url="get_currencies", method="public", body=params)
        #
        #     {
        #         jsonrpc: '2.0',
        #         result: [
        ...
        for i in range(0, len(currenciesResult)):
            ...
            instrumentsResponse = await self.fetch(url="get_instruments", method="public", body=self.extend(request, params))
            #
            #     {
            #         jsonrpc: '2.0',
            #         result: [
    ...
    async def fetch_balance(self, params={}):
        ...
        response = await self.fetch(url="get_account_summary", method="private", body=self.extend(request, params))
        #
        #     {
        #         jsonrpc: '2.0',
        #         result: {
    ...
    async def create_deposit_address(self, code, params={}):
        ...
        response = await self.fetch(url="create_deposit_address", method="private", body=self.extend(request, params))
        #
        #     {
        #         'jsonrpc': '2.0',
        #         'id': 7538,
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.fetch(url="get_current_deposit_address", method="private", body=self.extend(request, params))
        # response = await self.privateGetGetCurrentDepositAddress(self.extend(request, params))
        #
        #     {
        #         jsonrpc: '2.0',
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.fetch(url="ticker", method="public",body=self.extend(request, params))
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        response = await self.fetch(url="get_book_summary_by_currency", method="public", body=self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = await self.fetch(url="get_tradingview_chart_data", method="public", body=self.extend(request, params))
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        method = 'get_last_trades_by_instrument' if (since is None) else 'get_last_trades_by_instrument_and_time'
        if since is not None:
            request['start_timestamp'] = since
        if limit is not None:
            request['count'] = limit  # default 10

        response = await self.fetch(url=method, method="public", body=self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        if limit is not None:
            request['depth'] = limit
        response = await self.fetch(url="get_order_book", method="public", body=self.extend(request, params))
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.fetch(url="get_order_state", method="private", body=self.extend(request, params))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.fetch(url=side.lower(), method="private", body=self.extend(request, params))
        # response = await getattr(self, method)(self.extend(request, params))
        #
        #     {
        #         "jsonrpc": "2.0",
    ...
    async def edit_order(self, id, symbol, type, side, amount=None, price=None, params={}):
        ...
        response = await self.fetch(url="edit", method="private", body=self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.fetch(url="cancel", method="private", body=self.extend(request, params))
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        if symbol is None:
            ...
            method = 'cancel_all_by_instrument'
            market = self.market(symbol)
            request['instrument_name'] = market['id']
        response = await self.fetch(url=method, method="private", body=self.extend(request, params))
        # response = await getattr(self, method)(self.extend(request, params))
        return response
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if symbol is None:
            ...
            method = 'get_open_orders_by_currency'
        else:
            market = self.market(symbol)
            request['instrument_name'] = market['id']
            method = 'get_open_orders_by_instrument'
        response = await self.fetch(url=method, method="private", body=self.extend(request, params))
        # response = await getattr(self, method)(self.extend(request, params))
    ...
    async def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if symbol is None:
            ...
            currency = self.currency(code)
            request['currency'] = currency['id']
            method = 'get_order_history_by_currency'
        else:
            market = self.market(symbol)
            request['instrument_name'] = market['id']
            method = 'get_order_history_by_instrument'
        response = await self.fetch(url=method, method="private", body=self.extend(request, params))
        # response = await getattr(self, method)(self.extend(request, params))
        result = self.safe_value(response, 'result', [])
        return self.parse_orders(result, market, since, limit)
    ...
    async def fetch_order_trades(self, id, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.fetch(url="get_user_trades_by_order", method="private", body=self.extend(request, params))
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if symbol is None:
            ...
            request['currency'] = currency['id']
            if since is None:
                method = 'get_user_trades_by_currency'
            else:
                method = 'get_user_trades_by_currency_and_time'
                request['start_timestamp'] = since
        else:
            market = self.market(symbol)
            request['instrument_name'] = market['id']
            if since is None:
                method = 'get_user_trades_by_instrument'
            else:
                method = 'get_user_trades_by_instrument_and_time'
                request['start_timestamp'] = since
        if limit is not None:
            request['count'] = limit  # default 10
        response = await self.fetch(url=method, method="private", body=self.extend(request, params))
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['count'] = limit
        response = await self.fetch(url="get_deposits", method="private", body=self.extend(request, params))
    ...
    async def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['count'] = limit
        response = await self.fetch(url="get_withdrawals", method="private", body=self.extend(request, params))
    ...
    async def fetch_position(self, symbol, params={}):
        ...
        response = await self.fetch(url="get_position", method="private", body=self.extend(request, params))
    ...
    async def fetch_positions(self, symbols=None, since=None, limit=None, params={}):
        ...
        response = await self.fetch(url="get_positions", method="private", body=self.extend(request, params))
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = await self.fetch(url="withdraw", method="private", body=self.extend(request, params))
